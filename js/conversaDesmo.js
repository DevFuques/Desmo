...
function lidarComEntradaDoUsuario(mensagem) {
    ...
    // Respostas para conversas
        ...
        resposta = "Olá Space, fico muito feliz em te conhecer! Meu programador me criou a partir de um vídeo que ele viu seu, ele se inspira muito em você, ate começou a criar conteúdo de educação tech, ele acha você muito legal, estilosa e uma grande inspiração.";
